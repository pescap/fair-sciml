...
class BaseSimulator(ABC):
    ...
    def run_simulation(
        self, session_id: str, simulation_index: int, **parameters
    ) -> None:
    ...
    def run_session(
        self, parameter_ranges: Dict[str, tuple], num_simulations: int
    ) -> None:
        ...
        for i in range(num_simulations):
            ...
            self.run_simulation(session_id, simulation_index=i + 1, **params)
